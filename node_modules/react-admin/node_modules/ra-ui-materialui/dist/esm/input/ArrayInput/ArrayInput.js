...
export var ArrayInput = function (props) {
    var _a, _b;
    var className = props.className, defaultValue = props.defaultValue, label = props.label, isFetching = props.isFetching, isLoading = props.isLoading, isPending = props.isPending, children = props.children, helperText = props.helperText, resourceFromProps = props.resource, arraySource = props.source, validate = props.validate, variant = props.variant, _c = props.margin, margin = _c === void 0 ? 'dense' : _c, rest = __rest(props, ["className", "defaultValue", "label", "isFetching", "isLoading", "isPending", "children", "helperText", "resource", "source", "validate", "variant", "margin"]);
